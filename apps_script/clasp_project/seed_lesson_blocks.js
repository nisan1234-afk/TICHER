...
const LESSON_BLOCKS_SEED_DATA = {
  ...
  // ===== יחידה 1 — מבוא לתיירות ותיירות דיגיטלית (4 מחזורים, לפי התכנון הפדגוגי המלא) =====
  lesson_1: [
    // ----- מחזור 1: מהי תיירות ומהי אטרקציה תיירותית? -----
    {
      block_type: 'teach',
      title: 'מחזור 1: מהי תיירות ומהי אטרקציה תיירותית?',
      body: 'תיירות היא נסיעה מחוץ לסביבה הרגילה למטרות הנאה, בילוי או עסקים. היא כוללת ביקור במקומות, מפגש עם תרבויות, פעילויות פנאי ואטרקציות טבעיות או מעשה ידי אדם.\n\nאטרקציה תיירותית היא מוקד שמושך מבקרים; היא יכולה להיות טבעית, מלאכותית או אירוע.\n\nלא כל מקום הוא אטרקציה — אטרקציה טובה תמיד כוללת סיבה ברורה לביקור.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'quiz',
      title: 'מיינו: טבעית / מעשה ידי אדם / אירוע / לא בהכרח אטרקציה',
      question_prompt: 'מיינו כל דוגמה לקטגוריה המתאימה לה.',
      answer_scope: 'learning',
      game_data: {
        mode: 'classify',
        categories: ['טבעית', 'מעשה ידי אדם', 'אירוע', 'לא בהכרח אטרקציה'],
        items: ['חרמון', 'מוזיאון', 'פסטיבל', 'מרכז קניות מקומי', 'נחל', 'משחק כדורגל בינלאומי'],
    ...
    },
    {
      ...
      title: 'בודקים באתר שלנו: איזו אטרקציה היא?',
      question_prompt: 'בחרו את סוג האתר שלכם, וכתבו במשפט מה מושך אליו מבקרים.',
      answer_scope: 'project',
      project_section: '1',
      target_field: 'site_basic',
      game_data: {
        categories: ['טבעית', 'מעשה ידי אדם', 'אירוע'],
        fillPrompt: 'סוג האתר שלנו הוא __________.',
        evidenceLabel: 'קישור או תמונה של האתר',
        explainParts: ['מה מושך מבקרים לאתר הוא-'],
        checklist: ['סימנו קטגוריה אחת.', 'כתבנו סיבה קונקרטית לביקור, לא רק תיאור.']
      }
    },

    // ----- מחזור 2: מהי תיירות דיגיטלית? -----
    {
      block_type: 'teach',
      title: 'מחזור 2: מהי תיירות דיגיטלית?',
      body: 'תיירות דיגיטלית, תיירות אלקטרונית או תיירות 2.0 היא שימוש בטכנולוגיות מידע ותקשורת לתכנון, הזמנה, שיתוף מידע, שיווק וחוויית נסיעה.\n\nהיא משנה כיצד אנשים מתכננים, חווים ומשתפים טיולים — לפני הטיול, במהלכו ואחריו.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'quiz',
      title: 'תרחיש: אילו פעולות הן תיירות דיגיטלית?',
      question_prompt: 'תייר רואה יעד באינסטגרם, קורא ביקורות, מזמין כרטיס ומשתמש במפה כדי להגיע.\nסמנו אילו מהפעולות האלה הן תיירות דיגיטלית.',
      answer_scope: 'learning',
      game_data: {
        mode: 'select',
        options: ['רואה את היעד באינסטגרם', 'קורא ביקורות', 'מזמין כרטיס', 'משתמש במפה כדי להגיע'],
        correct: [0, 1, 2, 3],
        feedbackCorrect: 'נכון! כל הפעולות האלה משתמשות בטכנולוגיה כדי לעזור לתייר — לפני הטיול ובמהלכו.',
        feedbackIncorrect: 'כמעט — כל הפעולות כאן הן דוגמה לתיירות דיגיטלית, כל אחת בשלב אחר של המסע.'
      }
    },
    {
      block_type: 'question_structured',
      title: 'בודקים באתר שלנו: פעולה דיגיטלית לפני ובמהלך הביקור',
      question_prompt: 'מצאו באתר שלכם פעולה דיגיטלית אחת שהתייר יכול לבצע לפני הביקור, ואחת בזמן הביקור.',
      answer_scope: 'project',
      project_section: '3',
      target_field: 'digital_website',
      game_data: {
        categories: [],
        fillPrompt: 'לפני הביקור אפשר: __________.',
        evidenceLabel: 'קישור או צילום מסך',
        explainParts: ['בזמן הביקור אפשר-'],
        checklist: ['נתנו דוגמה קונקרטית לכל שלב, לא רק שם כלי.']
      }
    },

    // ----- מחזור 3: חמש הקטגוריות -----
    {
      block_type: 'teach',
      title: 'מחזור 3: חמש הדרכים שבהן הטכנולוגיה משנה את הטיול',
      body: 'לפני שאתם מגיעים ליעד, כנראה שכבר ראיתם עליו תמונות, קראתם ביקורות, בדקתם מחירים ואולי אפילו הזמנתם מקום.\nכל הפעולות האלה הן חלק מ־תיירות דיגיטלית.\n\nבעבר השתמשו בעיקר בסוכני נסיעות, חוברות ומפות נייר. היום אפשר לעשות כמעט הכול דרך הטלפון או המחשב.\n\nחמש דרכים שבהן הטכנולוגיה משנה את הטיול:',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'teach',
      title: '1. הזמנות מקוונות',
      body: 'אתרים ואפליקציות שמאפשרים להזמין טיסות, מלונות, סיורים ואטרקציות ישירות מהמסך.\n\nלדוגמה: הזמנת חדר במלון דרך Booking.com.\n\nאיך זה עוזר לתייר? אפשר להשוות מחירים, לבדוק זמינות ולהזמין בכל שעה ומכל מקום.\n\n💡 רעיון לתמונה: צילום מסך של עמוד הזמנת מלון.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'teach',
      title: '2. תיירות וירטואלית — VR ו־AR',
      body: 'טכנולוגיות שמאפשרות להתרשם ממקום עוד לפני שמגיעים אליו. אפשר לצפות בסיור של 360 מעלות, להסתובב בתוך מוזיאון באופן וירטואלי או לראות מידע דיגיטלי שמופיע על גבי המציאות.\n\nלדוגמה: סיור וירטואלי במוזיאון לפני הביקור.\n\nאיך זה עוזר לתייר? אפשר לראות אם המקום מעניין ומתאים עוד לפני שמחליטים להגיע.\n\n💡 רעיון לסרטון: קטע קצר של 30–60 שניות מתוך סיור וירטואלי במוזיאון או באתר תיירות.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'teach',
      title: '3. אתרי מידע וביקורת',
      body: 'אתרים שמציגים מידע, תמונות, דירוגים וחוות דעת של מבקרים אחרים.\n\nלדוגמה: בדיקת ביקורות ודירוג של מסעדה או אטרקציה בגוגל מפות או ב־Tripadvisor.\n\nאיך זה עוזר לתייר? אפשר ללמוד מניסיונם של אחרים ולקבל החלטה טובה יותר.\n\n💡 רעיון לתמונה: צילום מסך של מקום עם דירוג גבוה ולצדו כמה ביקורות.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'teach',
      title: '4. שיווק ברשתות החברתיות',
      body: 'אתרי תיירות ויעדים משתמשים באינסטגרם, בטיקטוק, ביוטיוב ובפייסבוק כדי למשוך מבקרים. הם מפרסמים תמונות, סרטונים, המלצות ותוכן של משפיענים.\n\nלדוגמה: סרטון קצר שמציג נוף, מלון או אטרקציה בצורה מושכת.\n\nאיך זה משפיע על התייר? לפעמים סרטון אחד מספיק כדי לגרום לאדם לחשוב: "לשם אני רוצה להגיע."\n\n💡 רעיון לסרטון: סרטון תיירות קצר שמציג יעד בצורה מושכת, ולאחריו שאלה: מה בסרטון גרם לכם לרצות לבקר?',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'teach',
      title: '5. אפליקציות סיוע לנוסע',
      body: 'אפליקציות שעוזרות לתייר במהלך הטיול עצמו. הן מסייעות בניווט, תחבורה ציבורית, תרגום, תכנון מסלול ואיתור מקומות.\n\nלדוגמה: שימוש ב־Google Maps כדי להגיע לאתר, או ב־Moovit כדי לתכנן נסיעה בתחבורה ציבורית.\n\nאיך זה עוזר לתייר? הוא יכול להסתדר גם במקום שאינו מכיר.\n\n💡 רעיון לתמונה: מפה המציגה מסלול הליכה או נסיעה ליעד תיירותי.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'teach',
      title: '⚠️ שימו לב',
      body: 'אותו כלי יכול לעזור לתייר בכמה דרכים. לדוגמה, בגוגל מפות אפשר:\n• לנווט למקום.\n• לקרוא ביקורות.\n• לראות תמונות.\n• לבדוק שעות פתיחה.\n\nלכן חשוב לא רק לזהות את שם הכלי, אלא להבין איך משתמשים בו.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'game',
      title: 'משחק זיכרון: התאימו בין הקטגוריה לדוגמה',
      game_type: 'memory',
      answer_scope: 'learning',
      game_data: {
        pairs: [
          { term: 'הזמנות מקוונות', definition: 'Booking.com — חיפוש והזמנת חדר במלון' },
          { term: 'תיירות וירטואלית — VR ו־AR', definition: 'סיור דיגיטלי במוזיאון לפני הביקור' },
          { term: 'אתרי מידע וביקורת', definition: 'Tripadvisor — בדיקת דירוגים וחוות דעת' },
          { term: 'שיווק ברשתות החברתיות', definition: 'סרטון באינסטגרם שמציג יעד תיירותי' },
          { term: 'אפליקציות סיוע לנוסע', definition: 'Moovit — תכנון נסיעה בתחבורה ציבורית' }
        ],
        feedbackCorrect: 'נכון! הדוגמה מתאימה לקטגוריה.',
        feedbackIncorrect: 'כמעט. חשבו: מה התייר עושה באמצעות הכלי — מזמין, מתרשם, בודק מידע, מקבל השראה או מסתדר בדרך?'
      }
    },
    {
      block_type: 'quiz',
      title: 'בדיקת הבנה קצרה',
      question_prompt: 'תייר רואה סרטון על מלון באינסטגרם, קורא עליו ביקורות ולאחר מכן מזמין חדר.\nבאילו סוגים של תיירות דיגיטלית הוא השתמש?',
      answer_scope: 'learning',
      game_data: {
        options: ['שיווק ברשתות החברתיות', 'אתרי מידע וביקורת', 'הזמנות מקוונות', 'תיירות וירטואלית', 'אפליקציות סיוע לנוסע'],
        correct: [0, 1, 2],
        feedbackCorrect: 'נכון! שיווק ברשתות החברתיות, אתרי מידע וביקורת והזמנות מקוונות.',
        feedbackIncorrect: 'כמעט. עברו שוב על מה שהתייר עשה, צעד אחר צעד: ראה סרטון, קרא ביקורות, הזמין חדר.'
      }
    },
    {
      block_type: 'question_structured',
      title: 'עכשיו תורכם: האתר שלכם (מפת נוכחות ראשונית)',
      question_prompt: 'חזרו לאתר התיירות שבחרתם לפרויקט. באילו מהקטגוריות מצאתם אותו? אפשר לבחור יותר מתשובה אחת. באיזו קטגוריה האתר בולט במיוחד?',
      answer_scope: 'project',
      project_section: '3',
      target_field: 'digital_website',
      game_data: {
        categories: ['הזמנות מקוונות', 'תיירות וירטואלית', 'אתרי מידע וביקורת', 'שיווק ברשתות החברתיות', 'אפליקציות סיוע לנוסע'],
        fillPrompt: 'השלימו: האתר שבחרנו בולט בתחום __________.',
        evidenceLabel: 'תנו הוכחה (קישור / צילום מסך / תמונה / שם האפליקציה או הפלטפורמה)',
        explainParts: [
          'מצאנו שהאתר משתמש ב-',
          'הדבר עוזר לתיירים בכך ש-',
          'לדעתנו השימוש הזה טוב / חלקי / חלש, משום ש-'
        ],
        checklist: [
          'נתנו דוגמה מהאתר שלנו.',
          'צירפנו הוכחה.',
          'הסברנו איך הכלי עוזר לתייר.',
          'כתבנו במילים שלנו.',
          'הוספנו גם דעה ולא רק תיאור.'
        ]
      }
    },

    // ----- מחזור 4: ביקורות ומקורות מידע -----
    {
      block_type: 'teach',
      title: 'מחזור 4: ביקורות ומקורות מידע',
      body: 'אתרי ביקורת ומדריכי נסיעות מציגים דירוגים, המלצות וחוויות של משתמשים. חשוב לקרוא כמה מקורות ולבדוק אמינות ועדכניות.\n\nבחומרים מופיעים: TripAdvisor, Lonely Planet, Yelp, Google Maps, Fodor’s ו-Booking.',
      media_type: '', media_url: '',
      answer_scope: 'learning'
    },
    {
      block_type: 'quiz',
      title: 'שתי ביקורות סותרות — מה חסר לפני שמחליטים?',
      question_prompt: 'הוצגו לכם שתי ביקורות סותרות על אותו מקום. סמנו אילו פרטים חסרים ונדרשים לפני שמחליטים.',
      answer_scope: 'learning',
      game_data: {
        options: ['תאריך הביקורת', 'מספר הביקורות הכולל', 'סוג המבקר (משפחה/יחיד/עסקי)', 'פירוט בביקורת עצמה', 'מקור נוסף לאימות'],
        correct: [0, 1, 2, 3, 4],
        feedbackCorrect: 'נכון! כל הפרטים האלה עוזרים להבין כמה לסמוך על הביקורת.',
        feedbackIncorrect: 'כמעט — כל אחד מהפרטים האלה משפיע על כמה אפשר לסמוך על ביקורת בודדת.'
      }
    },
    {
      block_type: 'question_structured',
      title: 'בודקים באתר שלנו: דירוג וביקורות',
      question_prompt: 'מצאו את האתר שלכם בשירות ביקורות (TripAdvisor, גוגל מפות וכד’). ציינו דירוג, מספר ביקורות, תאריך של ביקורת אחת, ומה ניתן ללמוד ממנה.',
      answer_scope: 'project',
      project_section: '3',
      target_field: 'digital_reviews',
      game_data: {
        categories: [],
        fillPrompt: 'הדירוג של האתר הוא __________ מתוך __________ ביקורות.',
        evidenceLabel: 'קישור לביקורת שבדקנו',
        explainParts: ['מה למדנו מהביקורת הזו-', 'האם היא נראית עדכנית ואמינה, ולמה-'],
        checklist: ['ציינו דירוג ומספר ביקורות מדויקים.', 'לא רק העתקנו ביקורת — הסברנו מה למדנו ממנה.']
      }
    }
  ],
